...
Gem::Specification.new do |s|
  ...
  s.authors     = ["Raymond"]
  s.email       = ["zhouyt@outlook.com"]
  s.homepage    = "https://github.com/RaymondChou"
  s.summary     = %q{A ruby implementation of the Line Thermal Printer ESC/POS Command Specifications.}
  s.description = %q{A ruby implementation of the Line Thermal Printer ESC/POS Command Specifications.}
